...
class InvoiceTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testDownloadingInvoiceReturnsResponse()
    {
        ...
        $invoice = m::mock('Dinkbit\ConektaCashier\Invoice[render,getPhantomProcess]', [m::mock('Dinkbit\ConektaCashier\BillableInterface'), new StdClass()]);
        $invoice->id = 'id';
        $invoice->date = time();
    ...
    public function testViewCanBeRendered()
    {
        ...
        $invoice = m::mock('Dinkbit\ConektaCashier\Invoice', [m::mock('Dinkbit\ConektaCashier\BillableInterface'), $__conektaInvoice]);
